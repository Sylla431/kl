...
<html lang="en" class="dark">
    ...
    <head>
        ...
        <title>Register - Marakadev - Employee</title>
        <!-- BEGIN: CSS Assets-->
            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="" class="-intro-x flex items-center pt-5">
                        ...
                        <span class="text-white text-lg ml-3"> Maraka<span class="font-medium">dev</span> </span>
                    </a>
                    <div class="my-auto">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        <div class="intro-x mt-8">
                            ...
                            <input type="text" class="intro-x login__input form-control py-3 px-4 border-gray-300 block mt-4" placeholder="Name" name="name">
                        ...
                        <div class="intro-x flex items-center text-gray-700 dark:text-gray-600 mt-4 text-xs sm:text-sm">
                            ...
                            <a class="text-theme-25 dark:text-theme-22 ml-1" href="">Privacy Policy</a>.
                        </div>
